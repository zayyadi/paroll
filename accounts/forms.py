...
class RegistrationForm(forms.ModelForm):
    ...
    first_name = forms.CharField(
        label='Enter First name', min_length=4, max_length=50, help_text='Required')
    last_name = forms.CharField(
        label='Enter last name', min_length=4, max_length=50, help_text='Required')
    ...
    class Meta:
        model = User
        fields = ('username', 'first_name', 'last_name','email', 'first_name',)
