...
urlpatterns = [
    ...
    path(
        ...
        views.acknowledge_document,
        name="acknowledge_document",
    ),
    path("documents/overview/", views.document_overview, name="document_overview"),
    path("assets/", views.my_assets, name="my_assets"),
    path("assets/overview/", views.asset_overview, name="asset_overview"),
    path("assets/<int:asset_id>/return/", views.return_asset, name="return_asset"),
    path("performance/", views.my_performance, name="my_performance"),
    path(
    ...
    path(
        "performance/one-on-ones/<int:meeting_id>/complete/",
        views.complete_one_on_one,
        name="complete_one_on_one",
    ),
    path("surveys/", views.my_surveys, name="my_surveys"),
    path("surveys/<int:survey_id>/submit/", views.submit_survey, name="submit_survey"),
    path("surveys/overview/", views.survey_overview, name="survey_overview"),
    path("learning/", views.my_learning, name="my_learning"),
    path(
        "learning/<int:enrollment_id>/complete/",
        views.complete_learning_course,
        name="complete_learning_course",
    ),
    path("learning/overview/", views.learning_overview, name="learning_overview"),
    path("benefits/", views.my_benefits, name="my_benefits"),
