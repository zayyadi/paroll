...
def main():
    ...
    parser.add_argument('--keepdb', action='store_true',
                       help='Keep the test database after tests')
    ...
    test_group.add_argument('--utils', action='store_true',
                          help='Run utility function tests')
    test_group.add_argument('--views', action='store_true',
                          help='Run view tests')
    test_group.add_argument('--permissions', action='store_true',
                          help='Run permission tests')
    test_group.add_argument('--signals', action='store_true',
                          help='Run signal handler tests')
    ...
    if not any([args.models, args.utils, args.views, args.permissions, 
                args.signals, args.integration, args.performance, 
                args.e2e, args.coverage, args.test]):
        args.all = True
